...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('contact_name', models.TextField(blank=True, max_length=1000, verbose_name='Имя')),
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='warranties', to='core.company', verbose_name='Компания')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='company_users', to='core.company', verbose_name='Компания')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='company_users', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('probability_of_victory', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Вероятность победы')),
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='company_recommends', to='core.company', verbose_name='Компания')),
            ],
            options={
